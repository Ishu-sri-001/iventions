  ...
  return (
    ...
    "
        ...
        <button
          ...
          className={`relative nav-menu-item  flex items-center overflow-hidden justify-center  cursor-pointer outline-none bg-yellow px-[1vw] h-full py-[1vw] rounded-bl-[1vw]  group ${
